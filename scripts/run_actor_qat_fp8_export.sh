...
export CUDA_VISIBLE_DEVICES=GPU-280b96e2-67fc-577e-ba63-1ccd9493c231
...
run_id=${BRC_RUN_ID:-actor_qat_fp8_export_s42_gpu1_$(date +%Y%m%d_%H%M%S)}
...
exec /home/caiyuliang/anaconda3/envs/brc/bin/python train.py \
 ...
 --critic_residual_compute_format=mxfp8 --critic_residual_compute_terms=main_plus_carry \
 --critic_residual_compute_rounding=rtn --critic_residual_compute_rht=false \
 --actor_training_recipe=carry_body_bf16_edge_qat --actor_body_compute=mxfp8_main_plus_carry \
